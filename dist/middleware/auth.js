...
exports.refreshGitHubValidation =
  exports.userRateLimit =
...
const optionalJWT = async (req, res, next) => {
  try {
    ...
    await (0, exports.authenticateJWT)(req, res, (error) => {
      if (error) {
        next();
      } else {
        next();
...
const refreshGitHubValidation = (intervalMinutes = 60) => {
  ...
  return async (req, res, next) => {
    ...
    try {
      const validation = await github_1.default.validateToken(
