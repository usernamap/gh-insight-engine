...
export declare const analysisQuerySchema: z.ZodObject<
  {
    includePrivate: z.ZodEffects<
      z.ZodOptional<z.ZodString>,
      boolean,
      string | undefined
    >;
    forceRefresh: z.ZodEffects<
      z.ZodOptional<z.ZodString>,
      boolean,
      string | undefined
    >;
      ...
      z.ZodObject<
        {
          ...
          analysisDepth: z.ZodOptional<
            z.ZodEnum<["basic", "standard", "detailed"]>
          >;
...
export declare const validateUserParams: (
  req: Request,
  res: Response,
  next: NextFunction,
) => Promise<void>;
export declare const validateRepoParams: (
  req: Request,
  res: Response,
  next: NextFunction,
) => Promise<void>;
export declare const validateDatasetParams: (
  req: Request,
  res: Response,
  next: NextFunction,
) => Promise<void>;
...
export declare const validateUserSearch: (
  req: Request,
  res: Response,
  next: NextFunction,
) => Promise<void>;
export declare const validateRepoSearch: (
  req: Request,
  res: Response,
  next: NextFunction,
) => Promise<void>;
export declare const validateAnalysisParams: (
  req: Request,
  res: Response,
  next: NextFunction,
) => Promise<void>;
export declare const validateMetadataUpdate: (
  req: Request,
  res: Response,
  next: NextFunction,
) => Promise<void>;
export declare const validateUserWithPagination: (
  req: Request,
  res: Response,
  next: NextFunction,
) => Promise<void>;
export declare const validateRepoWithPagination: (
  req: Request,
  res: Response,
  next: NextFunction,
) => Promise<void>;
export declare const validateUserAnalysis: (
  req: Request,
  res: Response,
  next: NextFunction,
) => Promise<void>;
