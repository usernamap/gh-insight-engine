...
export declare const validate: (schemas: ValidationSchemas) => (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
...
export declare const validateAuth: (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
export declare const validateUserParams: (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
export declare const validateRepoParams: (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
export declare const validateDatasetParams: (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
export declare const validatePagination: (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
export declare const validateUserSearch: (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
export declare const validateRepoSearch: (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
export declare const validateAnalysisParams: (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
export declare const validateMetadataUpdate: (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
export declare const validateUserWithPagination: (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
export declare const validateRepoWithPagination: (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
export declare const validateUserAnalysis: (req: Request, _res: Response, _next: NextFunction) => Promise<void>;
export declare const sanitizeInput: (req: Request, _res: Response, _next: NextFunction) => void;
export {};
