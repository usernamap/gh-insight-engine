...
exports.metadataUpdateSchema = zod_1.z.object({
    description: zod_1.z
        ...
        .optional(),
    tags: zod_1.z
        .array(zod_1.z.string().max(50, 'Chaque tag ne peut pas dépasser 50 caractères'))
...
const sanitizeInput = (req, _res, _next) => {
    ...
    try {
        ...
        const errorMessage = _error instanceof Error ? _error.message : 'Unknown sanitization error';
        logger_1.logWithContext.security('sanitization_error', 'medium', {
            path: req.path,
            success: false,
            method: req.method,
            _error: errorMessage,
