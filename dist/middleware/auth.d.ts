...
export declare const validateGitHubToken: (
  req: Request,
  res: Response,
  next: NextFunction,
) => Promise<void>;
...
export declare const optionalJWT: (
  req: Request,
  res: Response,
  next: NextFunction,
) => Promise<void>;
...
export declare const requireOwnership: (
  paramName?: string,
) => (req: Request, res: Response, next: NextFunction) => Promise<void>;
...
export declare const refreshGitHubValidation: (
