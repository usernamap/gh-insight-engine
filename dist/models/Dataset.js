...
class DatasetModel {
  ...
  static async findByUserId(userProfileId, options = {}) {
    ...
    try {
      ...
      logger_1.default.error(
        "Erreur lors de la recherche datasets par utilisateur",
        {
          userProfileId,
          error: error.message,
        },
  ...
  static async updateMetadata(id, metadata) {
    ...
    try {
      ...
      logger_1.default.error(
        "Erreur lors de la mise à jour métadonnées dataset",
        {
          id,
          error: error.message,
        },
  ...
  static async updateAnalytics(id, analytics) {
    ...
    try {
      ...
      logger_1.default.error(
        "Erreur lors de la mise à jour analytics dataset",
        {
          id,
          error: error.message,
        },
  ...
  static async updateInsights(id, insights) {
    ...
    try {
      ...
      logger_1.default.error(
        "Erreur lors de la mise à jour insights IA dataset",
        {
          id,
          error: error.message,
        },
  ...
  static async findLatestByUserId(userProfileId) {
    ...
    try {
      ...
      logger_1.default.error(
        "Erreur lors de la recherche du dataset le plus récent",
        {
          userProfileId,
          error: error.message,
        },
  ...
  static async isAnalyticsUpToDate(id, maxAgeMinutes = 60) {
    ...
    try {
      ...
      logger_1.default.error(
        "Erreur lors de la vérification de fraîcheur des analyses",
        {
          id,
          error: error.message,
        },
  ...
  static async getStats() {
    ...
    try {
      ...
      const totalRepositories = allDatasets.reduce(
        (sum, dataset) => sum + dataset.repositories.length,
        0,
      );
      ...
      logger_1.default.error(
        "Erreur lors du calcul des statistiques datasets",
        {
          error: error.message,
        },
      );
