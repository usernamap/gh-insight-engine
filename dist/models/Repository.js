...
class RepositoryModel {
    static async create(repoData, userId) {
        ...
        try {
            ...
            throw new Error(`Création repository échouée: ${_error.message}`);
        }
    }
    ...
    static async update(id, updateData) {
        ...
        try {
            ...
            throw new Error(`Mise à jour repository échouée: ${_error.message}`);
        }
    }
    ...
    static async delete(id) {
        ...
        try {
            ...
            throw new Error(`Suppression repository échouée: ${_error.message}`);
        }
    }
    ...
    static async upsert(repoData, userId) {
        ...
        try {
            ...
            throw new Error(`Upsert repository échoué: ${_error.message}`);
        }
    }
}
