...
class RepositoryModel {
  ...
  static async findByUserId(userId, options = {}) {
    ...
    try {
      ...
      logger_1.default.error(
        "Erreur lors de la recherche repositories par utilisateur",
        {
          userId,
          error: error.message,
        },
  ...
  static async delete(id) {
    ...
    try {
      ...
      logger_1.default.info("Repository supprimé avec succès", {
        repositoryId: id,
      });
    } catch (error) {
  ...
  static async search(filters) {
    ...
    try {
      ...
      logger_1.default.error(
        "Erreur lors de la recherche avancée repositories",
        {
          filters,
          error: error.message,
        },
  ...
  static async getStats() {
    ...
    try {
      ...
      logger_1.default.error(
        "Erreur lors du calcul des statistiques repositories",
        {
          error: error.message,
        },
      );
