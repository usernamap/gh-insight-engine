...
export declare class DatabaseService {
    ...
    updateDatasetAnalyses(datasetId: string, analytics?: AnalyticsExtension, insights?: InsightsExtension): Promise<PrismaDataset>;
    enrichRepositoriesWithDevOpsData(repositoryIds: string[], devOpsDataMap: Record<string, {
    ...
    areUserAnalyticsUpToDate(username: string, maxAgeMinutes?: number): Promise<{
        hasDataset: boolean;
        hasAnalytics: boolean;
        hasInsights: boolean;
