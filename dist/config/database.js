...
class DatabaseConfig {
    ...
    async initialize() {
        ...
        try {
            ...
            throw new Error(`Connexion base de données échouée: ${_error.message}`);
        }
    }
    ...
    async healthCheck() {
        ...
        try {
            ...
            logger_1.default.warn('Health check Prisma échoué', {
                error: _error.message,
            });
        }
        try {
            ...
            logger_1.default.warn('Health check Mongoose échoué', {
                error: _error.message,
            });
        }
