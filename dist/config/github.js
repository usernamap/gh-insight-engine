...
class GitHubConfig {
  ...
  async validateToken(token) {
    ...
    try {
      ...
      logger_1.default.error("Erreur validation token GitHub", {
        error: error.message,
      });
      return {
        valid: false,
      ...
      try {
        ...
        if (this.isRateLimitError(error) && attempt < maxRetries) {
          ...
          logger_1.default.warn(
            `Rate limit atteinte, attente de ${waitTime}ms`,
            {
              attempt: attempt + 1,
              maxRetries,
            },
        ...
        if (attempt === maxRetries) {
          logger_1.default.error(
            "Requête GraphQL échouée après tous les essais",
            {
              error: error.message,
  ...
  async checkRateLimit() {
    ...
    if (this.rateLimitInfo.remaining < 100) {
      ...
      if (waitTime > 0) {
        logger_1.default.warn(
          "Rate limit faible, attente avant prochaine requête",
          {
